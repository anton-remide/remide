/** ISO 3166-1 numeric → alpha-2 code mapping for TopoJSON → our data join */
export const numericToAlpha2: Record<string, string> = {
  ...
  '158': 'TW', '170': 'CO', '174': 'KM', '175': 'YT', '178': 'CG',
  ...
  '246': 'FI', '250': 'FR', '254': 'GF', '258': 'PF', '262': 'DJ',
  ...
  '533': 'AW', '534': 'SX', '540': 'NC', '548': 'VU', '554': 'NZ',
  '558': 'NI', '562': 'NE', '566': 'NG', '570': 'NU', '578': 'NO',
